     ...
     <div class="card shadow mb-4">
            ...
            <div class="card-body">
              ...
              while ($data = $sql->fetch_object()) { ?>
                        ...
                        <div class="col-md-12">
                        <div class="col-md-6">
                            <label for="exampleFormControlInput1">Stok Opname</label><br>
                             <div class="btn-group btn-group-toggle" data-toggle="buttons">
                             <label <?php if ($data->so == 'Buka'){ echo 'class="btn btn-dark  active"';  } else echo 'class="btn btn-dark "';  ?> >
                                          <input type="radio" name="so" id="status" autocomplete="off" value="Buka" <?php if ($data->so == 'Buka'){ echo 'checked'; } ?> > Buka
                                        </label>
                                        <label <?php if($data->so == 'Tutup'){ echo 'class="btn btn-dark active"';  }else echo 'class="btn btn-dark"'; ?>>
                                          <input type="radio" name="so" id="status" autocomplete="off" value="Tutup" <?php if($data->so == 'Tutup'){ echo 'checked'; }   ?> > Tutup
                                        </label>
                                      </div>
                                      </div><br>
